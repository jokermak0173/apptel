    ...
    <section class="content">
      <!-- Default box -->
        ...
        <div class="box-header with-border">
            <center><h4><b>Pendientes &nbsp;&nbsp;&nbsp; <?php echo $_SESSION["nombrePlaza"];?></b></h4></center> 
        </div>
        <div class="box-body">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control input-lg" id="comentarioRevision" name="comentarioContacto" required readonly>
                </div>
              </div>
