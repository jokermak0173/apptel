    ...
    <section class="content">
      <!-- Default box -->
        ...
        <div class="box-header with-border">
            <center><h4><b>Citados a entrevista &nbsp;&nbsp;&nbsp; <?php echo $_SESSION["nombrePlaza"];?></b></h4></center> 
        </div>
        <div class="box-body">
    ...
    <div class="modal-content">
      <form role="form" method="post" enctype="multipart/form-data">
        <div class="modal-header" style="background:#52A9E4; color:white" >
          ...
          <h4 class="modal-title">Calificar Citado</h4>
        </div>
                ...
                <div class="input-group">
                  ...
                  <select class="form-control input-lg" name="calificacionRecomendado" id="calificacionRecomendado"  required>
                    <option value="">Califica el citado</option> 
                      <option value="11">No se presento</option>
                      <option value="12">Rechazado</option>
                      <option value="13">Reingreso</option>
                      <option value="14">Pendiente</option>
                      <option value="19">Citado a curso</option>
                  </select>
                </div>
              </div>
