    ...
    <section class="content">
      <!-- Default box -->
        ...
        <div class="box-header with-border">
            <center><h4><b>Certificados &nbsp;&nbsp;&nbsp; <?php echo $_SESSION["nombrePlaza"];?></b></h4></center>
        </div>
        <div class="box-body">
    ...
    <div class="modal-content">
      <form role="form" method="post" enctype="multipart/form-data">
        <div class="modal-header" style="background:#52A9E4; color:white" >
          ...
          <h4 class="modal-title">Calificar Certificados</h4>
        </div>
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <select class="form-control input-lg" name="calificacionRecomendado" id="calificacionRecomendado"  required>
                    <option value="">Califica el certificado</option>
                      <option value="41">Baja</option>
                      <option value="49">Bono Pagado</option>
